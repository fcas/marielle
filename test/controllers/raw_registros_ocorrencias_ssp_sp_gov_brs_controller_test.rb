...
class RawRegistrosOcorrenciasSspSpGovBrsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "given minimal raw_registros_ocorrencias_ssp_sp_gov_br, should create" do
    assert_difference('RawRegistrosOcorrenciasSspSpGovBr.count') do
      post raw_registros_ocorrencias_ssp_sp_gov_brs_url, params: { raw_registros_ocorrencias_ssp_sp_gov_br: { dataocorrencia: @raw_registros_ocorrencias_ssp_sp_gov_br.dataocorrencia, cidade: @raw_registros_ocorrencias_ssp_sp_gov_br.cidade, uf: @raw_registros_ocorrencias_ssp_sp_gov_br.uf, rg: @raw_registros_ocorrencias_ssp_sp_gov_br.rg } }
    end

    assert_redirected_to raw_registros_ocorrencias_ssp_sp_gov_br_url(RawRegistrosOcorrenciasSspSpGovBr.last)
  end

  test "given raw_registros_ocorrencias_ssp_sp_gov_br without dataocorrencia, should not create" do
    assert_no_difference('RawRegistrosOcorrenciasSspSpGovBr.count') do
      post raw_registros_ocorrencias_ssp_sp_gov_brs_url, params: { raw_registros_ocorrencias_ssp_sp_gov_br: { cidade: @raw_registros_ocorrencias_ssp_sp_gov_br.cidade, uf: @raw_registros_ocorrencias_ssp_sp_gov_br.uf, rg: @raw_registros_ocorrencias_ssp_sp_gov_br.rg } }
    end
    assert_template :new
  end

  test "given raw_registros_ocorrencias_ssp_sp_gov_br without cidade, should not create" do
    assert_no_difference('RawRegistrosOcorrenciasSspSpGovBr.count') do
      post raw_registros_ocorrencias_ssp_sp_gov_brs_url, params: { raw_registros_ocorrencias_ssp_sp_gov_br: { dataocorrencia: @raw_registros_ocorrencias_ssp_sp_gov_br.dataocorrencia, uf: @raw_registros_ocorrencias_ssp_sp_gov_br.uf, rg: @raw_registros_ocorrencias_ssp_sp_gov_br.rg } }
    end
    assert_template :new
  end

  test "given raw_registros_ocorrencias_ssp_sp_gov_br without uf, should not create" do
    assert_no_difference('RawRegistrosOcorrenciasSspSpGovBr.count') do
      post raw_registros_ocorrencias_ssp_sp_gov_brs_url, params: { raw_registros_ocorrencias_ssp_sp_gov_br: { dataocorrencia: @raw_registros_ocorrencias_ssp_sp_gov_br.dataocorrencia, cidade: @raw_registros_ocorrencias_ssp_sp_gov_br.cidade, rg: @raw_registros_ocorrencias_ssp_sp_gov_br.rg } }
    end
    assert_template :new
  end

  test "given raw_registros_ocorrencias_ssp_sp_gov_br without rg, should not create" do
    assert_no_difference('RawRegistrosOcorrenciasSspSpGovBr.count') do
      post raw_registros_ocorrencias_ssp_sp_gov_brs_url, params: { raw_registros_ocorrencias_ssp_sp_gov_br: { dataocorrencia: @raw_registros_ocorrencias_ssp_sp_gov_br.dataocorrencia, cidade: @raw_registros_ocorrencias_ssp_sp_gov_br.cidade, uf: @raw_registros_ocorrencias_ssp_sp_gov_br.uf } }
    end
    assert_template :new
  end
  ...
  test "given minimal JSON request, should create raw_registros_ocorrencias_ssp_sp_gov_br" do
  ...
  test "given JSON request without dataocorrencia, should create raw_registros_ocorrencias_ssp_sp_gov_br" do
    assert_no_difference('RawRegistrosOcorrenciasSspSpGovBr.count') do
      post raw_registros_ocorrencias_ssp_sp_gov_brs_url, params: { format: :json, raw_registros_ocorrencias_ssp_sp_gov_br: { cidade: @raw_registros_ocorrencias_ssp_sp_gov_br.cidade, uf: @raw_registros_ocorrencias_ssp_sp_gov_br.uf, rg: @raw_registros_ocorrencias_ssp_sp_gov_br.rg } }
    end
    ...
    data = body['data']
    assert_equal "É necessário informar a data da ocorrência", data['dataocorrencia'][0]
  end

  test "given JSON request without cidade, should create raw_registros_ocorrencias_ssp_sp_gov_br" do
    assert_no_difference('RawRegistrosOcorrenciasSspSpGovBr.count') do
      post raw_registros_ocorrencias_ssp_sp_gov_brs_url, params: { format: :json, raw_registros_ocorrencias_ssp_sp_gov_br: { dataocorrencia: @raw_registros_ocorrencias_ssp_sp_gov_br.dataocorrencia, uf: @raw_registros_ocorrencias_ssp_sp_gov_br.uf, rg: @raw_registros_ocorrencias_ssp_sp_gov_br.rg } }
    end
    ...
    data = body['data']
    assert_equal "É necessário informar a cidade", data['cidade'][0]
  end

  test "given JSON request without uf, should create raw_registros_ocorrencias_ssp_sp_gov_br" do
    assert_no_difference('RawRegistrosOcorrenciasSspSpGovBr.count') do
      post raw_registros_ocorrencias_ssp_sp_gov_brs_url, params: { format: :json, raw_registros_ocorrencias_ssp_sp_gov_br: { dataocorrencia: @raw_registros_ocorrencias_ssp_sp_gov_br.dataocorrencia, cidade: @raw_registros_ocorrencias_ssp_sp_gov_br.cidade, rg: @raw_registros_ocorrencias_ssp_sp_gov_br.rg } }
    end
    ...
    data = body['data']
    assert_equal "É necessário informar a Unidade Federativa (UF)", data['uf'][0]
  end

  test "given JSON request without rg, should create raw_registros_ocorrencias_ssp_sp_gov_br" do
    assert_no_difference('RawRegistrosOcorrenciasSspSpGovBr.count') do
      post raw_registros_ocorrencias_ssp_sp_gov_brs_url, params: { format: :json, raw_registros_ocorrencias_ssp_sp_gov_br: { dataocorrencia: @raw_registros_ocorrencias_ssp_sp_gov_br.dataocorrencia, cidade: @raw_registros_ocorrencias_ssp_sp_gov_br.cidade, uf: @raw_registros_ocorrencias_ssp_sp_gov_br.uf } }
    end
    ...
    data = body['data']
    assert_equal "É necessário informar o RG da vítima", data['rg'][0]
  end
end
